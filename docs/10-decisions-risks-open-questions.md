...
| ADR-009 | Working name only pending clearance                                                                | likely affiliation/confusion risk with Waffarha                               |
...
| -------------------------------------------- | ------------------- | ------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| Name/IP dispute                              | High / existential  | counsel flags similarity; Waffarha objection            | working name only; clearance/license before public use                              |
...
1. Decide whether Waffarha relationship/permission exists. If not, authorize new-name work.
